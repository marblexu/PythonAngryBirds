...
class BeamGlass(Beam):
    ...
    def get_rect_list(self):
        if self.type == c.BEAM_TYPE_1: # the shortest length
            ...
            rect_list = [(501, 332, 201, 18), (415, 375, 201, 18),
                         (415, 397, 201, 18), (415, 419, 201, 18),]
...
class BeamWood(Beam):
    ...
    def get_rect_list(self):
        if self.type == c.BEAM_TYPE_1: # the shortest length
            rect_list = [(622, 706, 38, 17), (707, 640, 38, 17),
                         (750, 640, 38, 17), (707, 662, 38, 17)]
        elif self.type == c.BEAM_TYPE_2:
            rect_list = [(707, 552, 80, 17), (622, 574, 80, 17),
                         (707, 574, 80, 17), (622, 596, 80, 17)]
        elif self.type == c.BEAM_TYPE_3:
            rect_list = [(622, 464, 160, 17), (622, 486, 160, 17),
                         (622, 508, 160, 17), (622, 530, 160, 17)]
        elif self.type == c.BEAM_TYPE_4: # the longest length
            rect_list = [(415, 464, 201, 17), (415, 464, 201, 17),
                         (415, 486, 201, 17), (415, 508, 201, 17)]
        elif self.type == c.BEAM_TYPE_5: # the thick one
...
class BeamStone(Beam):
    ...
    def get_rect_list(self):
        if self.type == c.BEAM_TYPE_1: # the shortest length
            rect_list = [(750, 662, 38, 17), (707, 684, 38, 17),
                         (750, 684, 38, 17), (707, 706, 38, 17)]
        elif self.type == c.BEAM_TYPE_2:
            rect_list = [(707, 596, 80, 17), (622, 618, 80, 17),
                         (707, 618, 80, 17), (622, 640, 80, 17)]
        elif self.type == c.BEAM_TYPE_3:
            rect_list = [(415, 618, 160, 17), (415, 640, 160, 17),
                         (415, 662, 160, 17), (415, 684, 160, 17)]
        elif self.type == c.BEAM_TYPE_4: # the longest length
            rect_list = [(415, 530, 201, 17), (415, 553, 201, 17),
                         (415, 574, 201, 17), (415, 596, 201, 17)]
        elif self.type == c.BEAM_TYPE_5: # the thick one
